...
public class RSA {
    ...
    /**
     * 私钥解密,解密要求密文最大长度为128字节,超长需要分段解密
    ...
    /**
     * 公钥解密,解密要求密文最大长度为128字节,超长需要分段解密
     * @param encryptedData		已加密数据
    ...
    /**
     * 公钥加密,RSA加密明文最大长度117字节,超长需要分段加密
     * @param data			源数据
     * @param publicKey		公钥(BASE64编码)
     * @return
     * @throws Exception
    ...
    /**
     * 私钥加密,RSA加密明文最大长度117字节,超长需要分段加密	
     * @param data			源数据
     * @param privateKey	私钥(BASE64编码)
     * @return
     * @throws Exception
